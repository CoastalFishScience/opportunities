...
#### **Everglades coastal fisheries postdoc (Miami, FL)**

[Florida International University](https://environment.fiu.edu/) (FIU) and [Everglades National Park](https://www.nps.gov/ever/learn/nature/sfnrcaboutus.htm) (ENP) seek a postdoctoral researcher.\

**Duration:** 2.5 years\
**Start date:** Open until filled\
**Annual Salary:** \$61,000 - $64,000 (+ benefits package)\
**Location:** Flexible (If in person, the position is based in Miami, FL)\
...
**How To Apply:** Please email [Dr. Jenn Rehage](https://scholar.google.com/citations?hl=en&view_op=list_works&gmla=AC6lMd8pe5lMIwebbK2vDA0aqCLN30vyKodcfhdsGPY-PPbeXqqJwSTPHFdhi01ixFJhs0tkJ4z6oR0OlyRePA&user=X9VfvfIAAAAJ) at **rehagej@fiu.edu** and [Dr. Rolando Santos](https://scholar.google.com/citations?hl=en&user=SkxIVFAAAAAJ&view_op=list_works&sortby=pubdate) **rsantosc@fiu.edu** with the subject line **‘Postdoc 2025 + your name.’** In your email, please include (as a single PDF):\
